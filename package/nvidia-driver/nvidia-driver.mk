...
ifeq ($(BR2_PACKAGE_NVIDIA_DRIVER_CUSTOM_VERSION),y)
NVIDIA_DRIVER_VERSION=$(call qstrip,$(BR2_PACKAGE_NVIDIA_DRIVER_CUSTOM_VERSION_VALUE))
else
NVIDIA_DRIVER_VERSION = 390.67
endif

ifeq ($(BR2_PACKAGE_NVIDIA_DRIVER_USE_CUSTOM_RUNFILE),y)
NVIDIA_DRIVER_RUNFILE=$(call qstrip,$(BR2_PACKAGE_NVIDIA_DRIVER_CUSTOM_RUNFILE))
ifeq ($(wildcard $(NVIDIA_DRIVER_RUNFILE)),)
$(error BR2_PACKAGE_NVIDIA_DRIVER_CUSTOM_RUNFILE not found)
endif

NVIDIA_DRIVER_SITE_METHOD=file
NVIDIA_DRIVER_SITE=$(patsubst %/,%,$(dir $(NVIDIA_DRIVER_RUNFILE)))
NVIDIA_DRIVER_SOURCE=$(notdir $(NVIDIA_DRIVER_RUNFILE))
BR_NO_CHECK_HASH_FOR=$(NVIDIA_DRIVER_SOURCE)
else
